...
const NORWEGIAN_DATABASE = {
    ...
    conversations: {
        ...
        help: [
            "Я могуwdwffwe переводить слова с русского на норвежский.",
            "Спросите меняefefe любое слово или фразу для перевода.",
            "Могу дать случайноеefef норвежское слово для изучения.",
            "Помогу с базовойefefef норвежской лексикой."
        ],
